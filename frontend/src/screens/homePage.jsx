...
function HomePage() {
  ...
  return (
    <div className="md:grid grid-cols-10 h-screen grid-rows-8  flex flex-col  justify-between overflow-hidden">
      <div className="md:col-span-10 md:row-span-1 h-36 md:h-full">
        <Navbar phoneNav={phoneNav} handlePhoneNav={setPhoneNav} />
      </div>

      <div className="col-span-10 grow row-span-6 mt-6 md:mt-4 overflow-y-scroll">
        <Outlet />
      </div>
