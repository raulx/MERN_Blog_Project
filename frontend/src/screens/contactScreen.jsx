      ...
      <div className="container mx-auto flex md:flex-row flex-col-reverse gap-6 justify-center p-4 py-10 md:overflow-y-scroll">
        <div className="p-4 md:w-1/2">
          ...
          <p className=" my-6 text-xl">
            ...
            numquam id, molestias tempora sit deleniti, et reprehenderit
            mollitia similique eius excepturi esse. Reprehenderit molestias nam,
            rerum accusantium vitae impedit doloribus architecto aliquam
            praesentium, dicta recusandae?
          </p>
          <p className="text-xl">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto
            culpa vel, magni, sed, sapiente dignissimos optio numquam inventore
            ...
            placeat vero aliquam neque culpa saepe magni ad. Amet voluptates
            quod voluptatum vel.
          </p>
